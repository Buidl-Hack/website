...
export interface Contracts_Hubster_sol_ContractInterface
  ...
  encodeFunctionData(
    functionFragment: "hasProfileNft",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "ProofVerified(address)": EventFragment;
...
export interface Contracts_Hubster_sol_Contract extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Contracts_Hubster_sol_ContractInterface;
  ...
  filters: {
    ...
    "ProofVerified(address)"(user?: null): ProofVerifiedEventFilter;
    ProofVerified(user?: null): ProofVerifiedEventFilter;
